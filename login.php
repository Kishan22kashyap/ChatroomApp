...
<div class="login div">
    <h2>Login</h2>
    <p>
    This application allows users to send and receive messages instantly, 
    providing a smooth and responsive chat experience.
        <form action="" method="post">
            <h3>Username:</h3>
            <input type="text" placeholder="Enter Name" name="name"/> <!-- Added name attribute -->
            <h3>Mobile:</h3>
            <input type="number" placeholder="Enter Phone No" min="1111111" max="9999999999" name="phone"/>
